package com.example.capstone.UI.AddPromise;
...
public class AddPromiseFragment extends Fragment {
    private View v;
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState){
        v = inflater.inflate(R.layout.fragment_addpromise,container,false);
